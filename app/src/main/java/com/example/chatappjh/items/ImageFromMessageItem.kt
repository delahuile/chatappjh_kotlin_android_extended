...
class ImageFromMessageItem (val message: ImageMessage
    ...
    companion object {
        val TAG = "ImageFromMessage"
    }

    override fun bind(viewHolder: GroupieViewHolder, position: Int) {

        val thumb1View: ImageView = viewHolder.itemView.imageView_from_chatmessage

        expandedImageView = viewHolder.itemView.expanded_image_from
    ...
    private fun zoomImageFromThumb(thumbView: View, expandedImageView: ImageView, viewHolder: GroupieViewHolder) {
        ...
        viewHolder.itemView.containerFrom.getGlobalVisibleRect(finalBoundsInt, globalOffset)
